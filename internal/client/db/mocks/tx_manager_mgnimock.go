...
//go:generate minimock -i github.com/Murat993/chat-server/internal/client/db.TxManager -o ./mocks/tx_manager_mgnimock.go -n TxManagerMock
...
import (
	...
	mm_db "github.com/Murat993/chat-server/internal/client/db"
